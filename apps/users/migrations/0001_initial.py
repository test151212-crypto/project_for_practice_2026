# Generated by Django 4.2.7 on 2026-06-06 01:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('freelancer', 'Фрилансер'), ('customer', 'Заказчик'), ('moderator', 'Модератор'), ('admin', 'Администратор')], default='freelancer', max_length=20)),
