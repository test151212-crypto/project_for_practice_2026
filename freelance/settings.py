...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'freelance'),
...
# Celery
CELERY_BROKER_URL = os.getenv('REDIS_URL', 'redis://:6379')
CELERY_RESULT_BACKEND = os.getenv('REDIS_URL', 'redis://:6379')
